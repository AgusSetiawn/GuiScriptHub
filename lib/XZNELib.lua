...
function S9_:MakeGui(S91_arg0)
	...
	S97_.BackgroundColor3 = Color3.fromRGB(18, 18, 18) -- WindUI dark theme
	S97_.BackgroundTransparency = 0.05 -- More solid for modern look
	...
	S98_.CornerRadius = UDim.new(0, 12) -- WindUI rounded corners
	S98_.Parent = S97_

	S99_.Color = Color3.fromRGB(60, 60, 60) -- Subtle stroke
	S99_.Thickness = 1.2
	S99_.Transparency = 0.3 -- More visible
	S99_.Parent = S97_
