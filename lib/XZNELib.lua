...
do
    ...
    function a.b()
        ...
        -- Local icon implementation (replaces external loader)
        local l = {}
        ...
        local iconMap = {
            ...
            ["bell"] = "rbxassetid://10709782110",
            ["check"] = "rbxassetid://10709782172",
            ...
            for i, sInfo in ipairs(parsed) do
                ...
                local function updateVisuals(isActive, isHover)
                    ...
                    if isActive then
                        ...
                        local themeCol = (aa.Theme and aa.GetThemeProperty("Text", aa.Theme)) or Color3.fromRGB(200, 200, 200)
                        ...
                        if icon then
                            if isActive then
                                ...
                                ac(
                                    icon.ImageLabel,
                                    0.2,
                                    {ImageColor3 = themeCol, ImageTransparency = 0.4}
                                ):Play()
                            end
                        end
                    end
            ...
            aj.AddSignal(
                ...
                function()
                    ...
                    as.UIElements.Main.Main.Topbar.Center.Position =
                        UDim2.new(0, j + (as.UIPadding / ar.WindUI.UIScale), 0.5, 0)
                    as.UIElements.Main.Main.Topbar.Center.Size =
                        UDim2.new(1, -j - l - ((as.UIPadding * 2) / ar.WindUI.UIScale), 1, 0)
                end
            )
